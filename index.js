...
const typeDefs = gql`
    ...
    type Query {
        ...
        RecentlyPlayed: TracklistWithContext
        CurrentlyPlaying: RecentlyPlayedTrack
...
const resolvers = {
    Query: {
        ...
        TrackData: async(_, {id}, {dataSources}) => {
            return dataSources.spotifyAPI.GetTrackData(id);
        },
    },
};
